    ...
    <section id="contact" className="relative py-28">
      ...
      <div className="container mx-auto px-6 md:px-10">
        ...
        <div className="grid gap-14 md:grid-cols-2">
          {/* info card */}
          <div className="rounded-3xl border border-slate-200 bg-white/60 p-10 backdrop-blur">
              ...
              <div className="flex gap-4">
                {[
                  ...
                  <a
                    ...
                    aria-label={label}
                    target="_blank"
                    className="flex h-11 w-11 items-center justify-center rounded-full bg-indigo-600 text-white transition hover:-translate-y-1 hover:bg-indigo-700"
                  >
                    <Icon size={20} />
                  </a>
                ))}
